...
class ShoesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shoe" do
    assert_difference('Shoe.count') do
      post shoes_url, params: { shoe: { brand: @shoe.brand, condition: @shoe.condition, description: @shoe.description, location_id: @shoe.location_id, model: @shoe.model, price: @shoe.price } }
    end
  ...
  test "should update shoe" do
    patch shoe_url(@shoe), params: { shoe: { brand: @shoe.brand, condition: @shoe.condition, description: @shoe.description, location_id: @shoe.location_id, model: @shoe.model, price: @shoe.price } }
